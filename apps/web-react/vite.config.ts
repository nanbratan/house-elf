	...
	mergeConfig(sharedTestConfig, {
		...
		resolve: {
			...
			alias: {
				...
				'@/lib/utils': new URL('./src/lib/utils/cn.ts', import.meta.url).pathname
			}
		},
		...
		test: {
			...
			coverage: {
				...
				exclude: [
					...
					// The ai-elements catalogue: byte-identical upstream reference material,
					// so testing it would be testing shadcn. A component needing behavioural
					// change becomes our own file in src/lib/components/ and is tested there.
