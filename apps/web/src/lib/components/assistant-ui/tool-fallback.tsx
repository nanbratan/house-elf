...
// The registry types this as the bare `ToolCallMessagePartComponent`, whose `TArgs`
// and `TResult` both default to `any`. Pinning both to `unknown` keeps `result` off
// the `any` path — nothing here reads it except to stringify it.
const ToolFallbackImpl: ToolCallMessagePartComponent<unknown, unknown> = ({
	toolName,
	argsText,
	result,
	status,
