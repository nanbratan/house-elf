...
<div class="flex h-screen overflow-hidden">
  <aside
    class="bg-surface border-line flex shrink-0 flex-col overflow-hidden transition-[width] duration-200"
        ...
        {#each conversations as conversation (conversation.id)}
          ...
          <li>
            <a
              ...
              class="hover:bg-raised block truncate rounded-md px-3 py-2 text-sm whitespace-nowrap transition-colors"
  ...
  <div class="flex min-w-0 flex-1 flex-col">
    <header
      class="border-line flex h-12 shrink-0 items-center gap-3 border-b px-3"
    >
      <button
        type="button"
        ...
        class="text-muted hover:bg-raised hover:text-content rounded-md p-2 transition-colors"
      >
        <svg
          class="size-4"
          viewBox="0 0 16 16"
